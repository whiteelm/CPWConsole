...
c
      ...
      dimension y(neqn),work(1),iwork(25)
...
!      dimension y(neqn),wt(neqn),phi(neqn,82),p(neqn),yp(neqn),psi(82)
!      dimension alpha(82),beta(82),sig(82),w(82),v(82),g(82),
!     1  gstr(13),two(13)
...
c
   ...
   35   yout(l) = y(l) + hi*yout(l)
     ...
     2                 calfun)
      implicit real*8 (a-h,o-z)
      double precision  x(1),f(1),lawork(82),ajinv(82,82),w(1)
      double precision det(82)
      integer ipvt(82)
      external calfun
      maxc=0
      nt=n+4
...
c
   ...
   70 continue
      ...
      double precision a(lda,1),det(20),work(1)
